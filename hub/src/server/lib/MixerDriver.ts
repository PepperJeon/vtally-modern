...
import { Configuration, Connector } from '../../shared/mixer/interfaces'
    ...
    constructor(configuration: AppConfiguration, emitter: ServerEventEmitter) {
        ...
        this.emitter.on('config.changed', () => {
            ...
            if(configuration.getMixerSelection() !== this.currentMixerId) {
                ...
                if (haveValuesChanged(mixerSettings.getRestartFingerprint(), this.currentMixerSettings.getRestartFingerprint()) ){
