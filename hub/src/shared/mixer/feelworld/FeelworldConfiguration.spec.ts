import FeelworldConfiguration from './FeelworldConfiguration'
import ipPort from '../../domain/IpPort'
import ipAddress from '../../domain/IpAddress'

function createDefaultFeelworldConfiguration() {
    return new FeelworldConfiguration()
}

describe('getRequestInterval/setRequestInterval', () => {
    it("has a default", () => {
        const conf = createDefaultFeelworldConfiguration()
...
describe('fromJson/toJson', () => {
    it("does work", () => {
        ...
        conf.setPort(1234)
        conf.setRequestInterval(300)
        const loadedConf = createDefaultFeelworldConfiguration()
