...
**BREAKING CHANGES:**
* Node.js 24+ required (previously Node.js 12-16)
* Complete build system overhaul (CRA → Vite)
* Electron distribution method changed

**PERFORMANCE:**
* [PERFORMANCE] Development server start time: 30-60s → 151ms (200-400x improvement)
* [PERFORMANCE] Production build: 2.87 seconds
* [PERFORMANCE] Hot Module Replacement (HMR) with Vite 5.4.21

**MODERNIZATION:**
* [BREAKING] Migrated from Create React App to Vite 5.4.21
* [BREAKING] Upgraded to Electron 33 with electron-vite
* [ADDED] React 19.2.3 with latest features
* [ADDED] Tailwind CSS + shadcn/ui design system
* [ADDED] Vitest for testing (203/208 tests passing, 97.6%)
* [ADDED] Enhanced ESLint + Prettier configuration
* [ADDED] Dark mode support with theme switching

**BUG FIXES:**
* [BUGFIX] Fixed mixer-specific channel memory isolation
  - Mock → OBS 전환 시 정확한 Scene 개수 표시
  - 스위처별 독립 메모리 구현 (channelsByMixer Map 구조)
  - 스위처 전환 시 이전 설정 자동 복원
  - 기존 ~/.wifi-tally.json 자동 마이그레이션
* [IMPROVEMENT] Navigation bar layout optimization
  - 브라우저와 Electron 앱에서 일관된 레이아웃
* [BUGFIX] Don't suggest vMix is connected until a hello message is received and tally subscription was acknowledged #85
* [BUGFIX] Log file path typo fixed (vally → vtally) #93
